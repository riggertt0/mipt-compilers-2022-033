...
void Interpreter::Visit(std::shared_ptr<AssertStat> assert_stmt) {
...
void Interpreter::Visit(std::shared_ptr<StatListStat> stmt_list_stmt) {
  stmt_list_stmt->stmt_list->Accept(shared_from_this());
}

void Interpreter::Visit(std::shared_ptr<IfStat> if_stmt) {
...
void Interpreter::Visit(std::shared_ptr<IfElseStat> if_else_stmt) {
...
void Interpreter::Visit(std::shared_ptr<WhileStat> while_stmt) {
...
void Interpreter::Visit(std::shared_ptr<PrintStat> print_stmt) {
...
void Interpreter::Visit(std::shared_ptr<AssignmentStat> assignment_stmt) {
